...
import com.harbin.mymall.mymallorder.vo.OrderConfirmVo;
import com.harbin.mymall.mymallorder.vo.OrderSubmitVo;
import com.harbin.mymall.mymallorder.vo.SubmitOrderResponseVo;
...
//         下单 去创建订单 验证令牌 核算价格 锁定库存
        try {
            ...
            if (responseVo.getCode() == 0) {
                ...
                return "redirect:http://order.easymall.com/toTrade";
            }
        } catch (Exception e) {
